...
const EmbassyReports = ({ passengers }) => {
  ...
  function formatPassengers(data) {
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      console.log(
        '%cMyProject%cline:57%cpassengers[i]',
      ...
      formattedPassengers.push({
        ...
        saber_: `-${_.head(nameParts)}/${_.last(nameParts)} ${gTitle(data[i])}`,
        ...
        mofaNumberBarcode: <Barcode value={data[i].mofaNumber} displayValue={false} />,
      });
    }
