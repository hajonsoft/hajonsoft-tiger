...
const UmrahPackagesContainer = () => {
  ...
  return (
    <div>
            <CustomerHeader />
      <Box m={2}>
        <Typography variant="h6" align='center'>Umrah Packages</Typography>
      </Box>
...
export default UmrahPackagesContainer
